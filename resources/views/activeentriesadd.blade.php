...
<div class="page-container">
    ...
    <header class="header-desktop  w3-container w3-teal">
        ...
        <h1 class="text-white">Active Entries Add</h1>
        <br>
        <br>
        <br>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card w3-white">
                            <div class="card-header w3-blue">
                                <h3 class="text-white"> Add Entries</h3>
                            </div>
    @if (Session::has('msg'))
    ...
    <form action="{{ url('activeentries/store') }}" method="POST" class="form-horizontal">
            @csrf
        <div class="row">
            <div class="col-md-6">
                <lable for="">Bet_id</lable>
               <input type="text" class="form-control @error('bet_id') is-invalid @enderror" name="bet_id" value="" >
               @error('bet_id')
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('bet_value') is-invalid @enderror" name="bet_value" value="" >
                @error('bet_value')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('bet_type') is-invalid @enderror" name="bet_type" value="" >
                @error('bet_type')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control @error('players') is-invalid @enderror" name="players" value="" >
                @error('players')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
