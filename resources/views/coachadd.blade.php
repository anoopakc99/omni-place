...
<div class="page-container">
    ...
    <header class="header-desktop  w3-container w3-teal">
        ...
        <h1 class="text-white">Coach Add</h1>
        <br>
        <br>
        <br>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card w3-white">
                            <div class="card-header w3-blue">
                                <h3 class="text-white"> Coach Add</h3>
                            </div>
        @if (Session::has('msg'))
    ...
    <div class="card-body">
        ...
        <form action="{{ url('coach/store') }}" method="POST" class="form-horizontal">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <lable for="">Coach_name</lable>
                    <input type="text" class="form-control @error('coach_name') is-invalid @enderror" name="coach_name" value="">
                    @error('coach_name')
